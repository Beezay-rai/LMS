...
//        {
//            return await _context.Faculty.Where(x => x.Deleted == false).Select(x => new FacultyModel()
//            {
//                Id = x.Id,
//                Name = x.Name,
//            }).ToListAsync();
...
//        {
//            return await _context.Faculty.Where(x => x.Id == id && x.Deleted == false).Select(x => new FacultyModel()
//            {
//                Id = x.Id,
//                Name = x.Name,
//            }).FirstOrDefaultAsync();
//        }
//        public async Task<bool> InsertUpdateFaculty(FacultyModel model)
//        {
//            try
//            {
//                if (model.Id > 0)
